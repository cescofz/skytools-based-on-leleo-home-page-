<template>
  ...
  :style="xs?{height: '100%',width: '100%',top: '0',left:'0'}:(sm?{height: '98%',width: '98%',top: '1%',left:' 1%'}:{height: '96.6%',width: '99%',top: '1.7%',left:' 0.5%'})">
    ...
    <div v-show="!isloading && !isClearScreen" :style="xs||sm?{'overflow-y': 'auto','overflow-x': 'hidden'}:{}">
        <v-row>
            ...
            <v-col cols="12" md="8" lg="9" style="height: 100vh;" :style="xs||sm ?{}:{'overflow': 'auto'}">
                ...
                :formattedDate=formattedDate :projectcards=projectcards @open-rw="showRw = true" @open-supercandle="showSuperCandle = true" @open-query-height="showQueryHeight = true" @open-calendar="showCalendar = true"></homeright>
            </v-col>
        </v-row>
    </div>
	...
	<calendar v-show="showCalendar" @close="showCalendar = false"></calendar>
